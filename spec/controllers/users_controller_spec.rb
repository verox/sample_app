...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    describe "for signed-in user" do
      ...
      it "should have delete link by micropost" do
        get :show, id: @user
        response.should have_selector("a", href: "/microposts/#{@micropost.id}", content: "delete")
      end
    end
    ...
    describe "for non-signed-in user" do
      ...
      it "should not have delete link by micropost" do
        get :show, id: @user
        response.should_not have_selector("a", content: "delete")
      end
    end
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      it "should have redirect to the user show page" do
        put :update, id: @user, user: @attr
