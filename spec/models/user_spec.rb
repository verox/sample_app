...
describe User do
  ...
  describe "password validations" do
    ...
    it "should requirea a matching password confirmation" do
  ...
  describe "password encryption" do
    ...
    describe "admin attribute" do
      before(:each) do
        @user = User.create!(@attr.merge(email: "new-user@example.com")) 
      end
  ...
  describe "micropost associations" do
    ...
    describe "status feed" do
      ...
      it "should include the microposts of followed user" do
